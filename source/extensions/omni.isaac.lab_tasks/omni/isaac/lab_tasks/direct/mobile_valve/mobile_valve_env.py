...
class MobileValveEnv(DirectRLEnv):
    ...
    def _compute_rewards(
        ...
        self.extras["log"] = {
            ...
            "xy_distance": xy_distance.mean(),  # XY 거리 로깅
            "z_diff": z_diff.mean(),  # Z 축 차이 로깅
        ...
        #print("xy_distance:", xy_distance.cpu().numpy())
        #print("is_xy_aligned:", is_xy_aligned.cpu().numpy())
        #print("z_diff:", z_diff.cpu().numpy())
        #print("z_reward:", z_reward.cpu().numpy())
        # 액션 벡터 확인
